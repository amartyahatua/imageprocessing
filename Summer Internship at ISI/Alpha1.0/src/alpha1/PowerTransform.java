...
{
	public String getPowertransform(String path,String inputImageName,String extension,double gamaValue)
	{
		BufferedImage image=null;
		String imageName=path;
		String outPutImageName = inputImageName.concat("_PowerTransform");
		...
		for(int h = 0;h<height;h++)
		{
			for(int w = 0;w<width;w++)
			{
				transformed[h][w]= Math.pow(grayScale[h][w],gamaValue);			
