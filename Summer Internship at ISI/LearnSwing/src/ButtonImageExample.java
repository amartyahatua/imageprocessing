...
public class ButtonImageExample extends JFrame {
    ...
    private void initComponenets() {
        ...
        //                                                       
        JButton okButton = new JButton("OK", new ImageIcon("C:/Documents and Settings/Administrator/Desktop/ah/out.bmp" ));
        okButton.setMnemonic('O');
        JButton cancelButton = new JButton("CANCEL", new ImageIcon("C:/Documents and Settings/Administrator/Desktop/ah/lena.bmp"));
