...
public class Thresholding 
{
	...
	public void getThreshold(String path)
	{
		...
		Thresholding thrshld = new Thresholding();
		...
		storePixelRed = thrshld.getRGB(file,1);
		storePixelGreen= thrshld.getRGB(file,2);
		storePixelBlue = thrshld.getRGB(file,3);
		...
		File outputFile = new File("out_threshold.bmp");     /*Initializing the output image named as "out.bmp"*/
