...
public class ImageGrowing 
{
	...
	public int [][] growImage(int inPut[][]) throws IOException
	{
		...
		ImageGrowing imgGrng = new ImageGrowing();
	...
	public static void main(String args[]) throws IOException
	{
		...
		for(int h = 1; h<height-1; h++)
		{
			for(int w = 1; w<width-1; w++)
			{
				...
				if(storePixelRed[h][w]==255)
					resultRed=imgGrng.growImage(storePixelRed);					
